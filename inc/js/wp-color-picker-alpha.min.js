      ...
      o.widget("wp.wpColorPicker", o.wp.wpColorPicker, {
        ...
        _addListeners: function () {
          ...
          (this.alphaOptions.defaultWidth = t.width()),
            ...
            (a.colorAlpha = a.toggler.find("span.color-alpha").css({
              width: "30px",
              height: "100%",
              position: "absolute",
              top: 0,
            ...
            t.iris({
              change: function (o, t) {
                a.colorAlpha.css({
                  "background-color": t.color.to_s(
                    a.alphaOptions.alphaColorType
                  ),
                }),
                  "function" == typeof a.options.change &&
                    a.options.change.call(this, o, t);
              },
            }),
            ...
            t.on("change", function (i) {
              ...
              (t.hasClass("iris-error") ||
                ...
                "function" == typeof a.options.clear &&
